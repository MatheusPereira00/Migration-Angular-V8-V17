...
import { RouterModule, Routes, Router, ActivatedRoute, RouterLink } from '@angular/router';
...
export class StudentAddComponent implements OnInit {
	...
	studentAddForm: UntypedFormGroup;
	index: any;

	constructor(private formBuilder: UntypedFormBuilder, private router: Router, private route: ActivatedRoute, private studentService: StudentService, private toastr: ToastrService) {
